...
def main(inputfile, hist, outputdir='plots', outputfile='output.png'):
    ...
    gaus = TF1('gaus','gaus',0.05,0.8) # for 30 GeV
    expo = TF1('expo','expo',0.80,0.96) # for 30 GeV

    gaus = TF1('gaus','gaus',0.05,0.85) # for 40 GeV
    expo = TF1('expo','expo',0.85,0.98) # for 40 GeV
...
if __name__ == '__main__' :
    ...
    outputdir = 'fitresult_fPi0L_gausexpo'
